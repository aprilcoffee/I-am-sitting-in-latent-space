...
def sendOSCtoMax_answer(person,text,fileName):
    ...
    client.send_message("/fileNameAnswer", "/Users/AprilCoffee/Documents/GitHub/I-am-sitting-in-latent-space/soft_rotation/python/" + fileName)
...
def sendOSCtoMax_question(person,text,fileName):
    ...
    client = udp_client.SimpleUDPClient(args.ip, args.port)
    client.send_message("/fileNameQuestion", "/Users/AprilCoffee/Documents/GitHub/I-am-sitting-in-latent-space/soft_rotation/python/" + fileName)
