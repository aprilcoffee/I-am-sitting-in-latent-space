...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 295.75, 654.326171875, 29.5, 22.0 ],
									"text" : "* 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 219.25, 813.326171875, 78.0, 22.0 ],
									"text" : "normalize~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 374.25, 515.326171875, 97.0, 22.0 ],
									"text" : "scale 0. 64. 1. 3."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 403.75, 726.326171875, 30.0, 22.0 ],
									"text" : "*~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 87.25, 635.326171875, 60.0, 22.0 ],
									"text" : "clip 0 128"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 216.25, 543.326171875, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 216.25, 690.326171875, 109.0, 22.0 ],
									"text" : "tapout~ 1000 2000"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 216.25, 654.326171875, 72.0, 22.0 ],
									"text" : "tapin~ 1000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 87.25, 580.326171875, 32.0, 22.0 ],
									"text" : "+ 25"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 219.25, 786.326171875, 30.0, 22.0 ],
									"text" : "*~ 1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "signal", "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 85.25, 674.326171875, 22.0, 140.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 178.25, 274.326171875, 95.0, 22.0 ],
									"text" : "sfplay~ @loop 1"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 219.25, 895.326171875, 30.0, 30.0 ]
								}
...
,
					"patching_rect" : [ 223.75, 609.673827999999958, 39.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 318.0, 629.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1452.0, 99.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 862.0, 366.0, 103.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 842.0, 214.0, 47.0, 22.0 ],
					"text" : "clip 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 843.5, 165.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 836.0, 121.0, 82.0, 22.0 ],
					"text" : "peakamp~ 25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 849.0, 283.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1032.0, 154.0, 71.5, 22.0 ],
					"text" : "biquad~"
				}
...
,
					"patching_rect" : [ 1144.0, 113.0, 190.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numpoints" : 512,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1032.0, 209.0, 497.0, 206.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 1144.0, 154.0, 95.0, 23.0 ],
					"text" : "filterdetail"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1315.0, 25.0, 30.0, 20.0 ],
					"text" : "q"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1315.0, 48.0, 55.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1229.5, 25.0, 73.0, 20.0 ],
					"text" : "frequency"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1229.5, 48.0, 55.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1144.0, 25.0, 34.0, 20.0 ],
					"text" : "gain"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1144.0, 48.0, 55.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1102.0, 475.0, 50.5, 22.0 ],
					"text" : "reson~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 225.75, 657.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
