...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 311.0, 93.0, 82.0, 22.0 ],
					"text" : "rampsmooth~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 321.0, 248.0, 40.0, 22.0 ],
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 368.0, 129.0, 53.0, 22.0 ],
					"text" : "clip 0. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 146.0, 239.0, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 273.0, 71.0, 35.0, 22.0 ],
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 283.0, 401.0, 40.0, 22.0 ],
					"text" : "*~ 0.7"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 405.0, 88.0, 82.0, 22.0 ],
					"text" : "peakamp~ 25"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 340.5, 332.0, 89.0, 22.0 ],
					"text" : "reson~ 1 440 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 4,
					"numoutlets" : 0,
					"patching_rect" : [ 296.0, 502.0, 75.0, 22.0 ],
					"text" : "dac~ 1 2 3 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 990.0, 113.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 367.0, 183.0, 110.0, 22.0 ],
					"text" : "scale 0. 1. 3000 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 570.0, 168.0, 71.5, 22.0 ],
					"text" : "biquad~"
				}
...
,
					"patching_rect" : [ 682.0, 127.0, 190.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numpoints" : 512,
					"outlettype" : [ "" ],
					"patching_rect" : [ 570.0, 223.0, 497.0, 206.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "", "", "", "", "", "" ],
					"patching_rect" : [ 682.0, 168.0, 95.0, 23.0 ],
					"text" : "filterdetail"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 853.0, 39.0, 30.0, 20.0 ],
					"text" : "q"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 853.0, 62.0, 55.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 767.5, 39.0, 73.0, 20.0 ],
					"text" : "frequency"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 767.5, 62.0, 55.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 682.0, 39.0, 34.0, 20.0 ],
					"text" : "gain"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 682.0, 62.0, 55.0, 22.0 ]
				}
